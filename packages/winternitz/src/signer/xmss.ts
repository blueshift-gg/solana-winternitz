...
import { SecretKey } from '../hazmat/xmss.js';
import type { Signature } from '../xmss.js';

/** Definition 8 signing state made durable in an exclusively locked xmss key file. */
export type SigningKey = PersistentSigningKey<Signature>;

/** Open or create a persistent xmss signer. */
